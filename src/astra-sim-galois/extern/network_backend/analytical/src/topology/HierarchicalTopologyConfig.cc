...
HierarchicalTopologyConfig::HierarchicalTopologyConfig(
    ...
    std::vector<int> link_failure_per_dim) noexcept
    : dimensions_count(dimensions_count),
      ...
      link_failure_per_dim(link_failure_per_dim) {}
...
int HierarchicalTopologyConfig::
    getLinkFailreForDim(int dimension) const noexcept{
  return link_failure_per_dim[dimension];  
}