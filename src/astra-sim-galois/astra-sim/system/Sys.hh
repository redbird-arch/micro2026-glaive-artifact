...
class Sys : public Callable {
 public:
  ...
  ComType current_layer_collective_type; // Sys -> HalfRing(Ring) -> sim_send; handle the fault tolerant communication for other collectives except for All-to-All
  ...
  std::string external_collective_file;
  std::map<std::pair<std::string, std::string>, Tick> external_collective_delays;
  ...
  void load_external_collective_file(const std::string& path);
  Tick lookup_external_collective_delay(
