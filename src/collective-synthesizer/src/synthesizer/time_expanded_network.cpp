...
void TimeExpandedNetwork::transferChunk(const NpuID src,
    ...
    const Time time) noexcept {
        ...
        // Emit link-chunk matching information through thread-local output.
        ThreadOutput::output("[EventTime ");
        ThreadOutput::output(currentTime_);
        ThreadOutput::output(" us] ");
        ThreadOutput::output("Chunk ");
        ThreadOutput::output(chunk);
        ThreadOutput::output(": ");
        ThreadOutput::output(src);
        ThreadOutput::output(" -> ");
        ThreadOutput::output(dest);
