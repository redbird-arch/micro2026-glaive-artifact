...
| 9(a) | `Figure09a_BPI_Distribution.pdf` | `simulation/simulation_exp/plots/reference_variant_bpi_distribution.pdf` | `scripts/run_simulation_direct.sh` |
| 9(b) | `Figure09b_Speedup_vs_BPI.pdf` | `simulation/simulation_exp/plots/speedup_vs_bpi.pdf` | `scripts/run_simulation_direct.sh` |
...
| 11(a) | `Figure11a_Torus_JLU.pdf` | `simulation/simulation_exp/plots/torus_jain_adjusted_link_utilization.pdf` | `scripts/run_simulation_direct.sh` |
